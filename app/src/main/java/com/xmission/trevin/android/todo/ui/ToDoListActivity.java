...
import static com.abaijan.todo.service.AlarmService.EXTRA_ITEM_CATEGORY_ID;
import static com.abaijan.todo.service.AlarmService.EXTRA_ITEM_ID;
...
import com.abaijan.todo.data.ToDoPreferences;
...
import com.abaijan.todo.provider.ToDoProvider;
import com.abaijan.todo.service.AlarmService;
import com.abaijan.todo.service.PasswordChangeService;
import com.abaijan.todo.service.ProgressReportingService;
...
public class ToDoListActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (currentUser == null) {
            // Пользователь не залогинен - отправляем на экран входа
        ...
        syncService.syncTasksFromFirestore(new FirestoreSyncService.SyncCallback() {
            @Override
    ...
    class NewButtonListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            try {
                ...
                // Передаём текущую выбранную категорию (удобство)
                long selectedCategory = prefs.getSelectedCategory();
                if (selectedCategory < 0) {
                ...
                Log.e(TAG, "Error starting ToDoDetailsActivity", e);
                Toast.makeText(ToDoListActivity.this,
                        "Ошибка при открытии формы создания задачи: " + e.getMessage(),
                ...
                .setPositiveButton("Да", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        GoogleSignInClient googleSignInClient =
                                GoogleSignIn.getClient(ToDoListActivity.this, gso);
